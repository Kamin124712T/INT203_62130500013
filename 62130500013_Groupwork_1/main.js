const app = {
  data() {
    return {
      ...
      dTYtext: [
        ["อยากเพิ่มน้ำหนักต้องกินอะไร? | NUGIRL TALK", "รู้มั้ยทำไมผมถึงยาวช้า? | NUGIRL TALK"],
        ["Review คณะเกษตรศาสตร์ มช. ห้องปฏิบัติการสุดล้ำ! แถมที่ฝึกงานวิวสวยระดับล้าน!", "CP Young Innovator Scholarship"],
        ["TR12 :   Review! อุปกรณ์วาดรูปสำหรับว่าที่เด็กสถาปัตย์ เค้าใช้อะไรกันบ้างนะ ?", "TR12 : กัปตันอันน์ รีวิว! การเป็นเด็กกิจกรรมได้ประสบการณ์มากกว่าที่คิด!"],
        ["คุยมันๆ กับ \"แพรวา บิวกิ้น พีพี\" พร้อมซิงเกิลสุดพิเศษ #มันดีเลย  | Dek-D Live", "ไขความสัมพันธ์ของ \"เซ้นต์ มีน พีค ฟ้า\" จากหนัง \#วอนเธอ"]
      ],
